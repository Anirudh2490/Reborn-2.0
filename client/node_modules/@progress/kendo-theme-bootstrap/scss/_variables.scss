...
@import "../modules/@progress/kendo-theme-default/scss/mixins/core/math";
...
$button-calc-size: #{$button-inner-calc-size} + #{$input-border-width * 2};
...
$input-calc-size: #{$input-inner-calc-size} + #{$input-border-width * 2};

$input-icon-offset: 6.5px !default;

// Pickers
$picker-select-border-width: 1px !default;
$picker-select-padding-x: $button-padding-y !default;
$picker-select-padding-y: $button-padding-y !default;
$picker-select-line-height: $line-height !default;

$picker-select-size: add-three($picker-select-padding-x * 2, $icon-size, $picker-select-border-width) !default;
$picker-icon-offset: calc(#{$picker-select-size} + #{$input-icon-offset}) !default;
...
// Component
$component-bg: $component-bg !default;
$component-text: $component-color !default;
$component-border: $component-border-color !default;
...
$tabstrip-border-width: $nav-tabs-border-width !default;

$tabstrip-item-padding-x: $nav-item-padding-x !default;
$tabstrip-item-padding-y: $nav-item-padding-y !default;
$tabstrip-item-border-width: $nav-tabs-border-width !default;
$tabstrip-item-border-radius: $nav-tabs-border-radius !default;
...
$tabstrip-content-border-width: $nav-tabs-border-width !default;
...
$tabstrip-text: $panel-text !default;
$tabstrip-border: $nav-tabs-border-color !default;
...
$tabstrip-item-hovered-border: $nav-tabs-link-hover-border-color !default;

$tabstrip-item-selected-bg: $nav-tabs-link-active-bg !default;
$tabstrip-item-selected-text: $nav-tabs-link-active-color !default;
$tabstrip-item-selected-border: $nav-tabs-link-active-border-color !default;
...
$tabstrip-content-border: $panel-border !default;
...
$grid-sorting-index-font-size: ($icon-size * .75);
$grid-sorting-index-height: $icon-size !default;
$grid-sorting-index-spacing-y: 2px;
...
$treeview-text: $widget-text !default;
$treeview-border: null !default;

$treeview-item-hovered-text: $list-group-hover-color !default;
$treeview-item-hovered-bg: $list-group-hover-bg !default;
$treeview-item-hovered-border: $node-hovered-bg !default;
...
$treeview-item-focused-shadow: 0 0 0 2px $base-border !default;
$treeview-item-selected-focused-shadow: 0 0 0 2px rgba( $node-selected-border, .5 ) !default;
...
$panelbar-header-hovered-bg: $header-hovered-bg !default;
$panelbar-header-hovered-text: $header-hovered-text !default;
$panelbar-header-hovered-border: $header-hovered-border !default;
$panelbar-header-hovered-gradient: $header-hovered-gradient !default;

$panelbar-header-selected-bg: $header-selected-bg !default;
$panelbar-header-selected-text: $header-selected-text !default;
$panelbar-header-selected-border: $header-selected-border !default;
$panelbar-header-selected-gradient: $header-selected-gradient !default;
...
$multiviewcalendar-content-padding-y: 0;
$multiviewcalendar-navigation-margin-x: 0;
$multiviewcalendar-navigation-margin-y: #{add-three( 2 * $calendar-header-padding-y, $calendar-header-height, 2 * $button-border-width) };
...
$window-title-line-height: 1.3 !default;
...
$window-shadow: null !default;
$window-focused-shadow: null !default;
...
// Dialog
$dialog-buttongroup-padding-x: $window-inner-padding-x !default;
$dialog-buttongroup-padding-y: $window-inner-padding-y !default;
$dialog-buttongroup-border-width: 1px !default;

$dialog-button-gap: .5rem !default;

$dialog-stretched-button-padding-x: $button-padding-x !default;
$dialog-stretched-button-padding-y: $button-padding-y !default;
$dialog-stretched-button-border-width: $button-border-width !default;
...
$scrollview-pager-height: add-three($scrollview-pagebutton-size, 2 * $scrollview-pager-item-border-width, $scrollview-pager-item-spacing / 2 ) !default;
...
$switch-label-spacing: add-two($switch-label-outer-spacing, $switch-label-inner-spacing);
$switch-label-occupied-space: add-three(-$switch-handle-size, -$switch-label-spacing, -$switch-container-padding-x);
$switch-label-text-transform: null !default;

$switch-label-position: add-two($switch-label-outer-spacing, -$switch-container-border-width);
$switch-label-width: calc(100% + #{$switch-label-occupied-space});
...
$scheduler-current-time-color: #f00;
